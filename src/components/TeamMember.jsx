...
const TeamMember = ({imageUrl, fullName, role, holder, executive, president, last, even}) => {
  return (
        <>
            <div className={`w-full flex ${!even && "flex-row-reverse"} justify-center max-h-40 md:max-h-56`}>
                ...
                <div className="w-40 md:w-56 flex justify-center mx-4">
                    <div className="h-40 md:h-56 w-40 md:w-56 bg-cover bg-center rounded-full border-8" style={{backgroundImage: `url(${imageUrl})`}}></div>
                </div>
