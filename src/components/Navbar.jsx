...
const Navbar = () => {
  return (
      <>
      <div className="bg-opacity-100 absolute top-0 left-0 z-50">
    ...
    <div className="w-screen flex justify-center items-center bg-gray-100 absolute top-0 shadow-md">
        ...
        <ul className="w-screen p-5 text-center flex justify-center items-center flex-row  pr-10 pl-10 ml-52">
            {navbarData.map((item) =>
                    <li className="flex-auto font-poppins font-bold">
                        <a href={item.href}><FontAwesomeIcon icon={item.icon} className="text-gray-600"/> {item.text} </a>
                    </li>
                )}
