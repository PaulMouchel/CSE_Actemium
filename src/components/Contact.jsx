        ...
        <Title id="contact" textColor={textColor}>Nous contacter</Title>
          <div>
            ...
            <form onSubmit={sendEmail} className="xl:mx-80 pb-6 flex flex-col items-center">
              ...
              <button className="mt-2 transition duration-500 ease-in-out bg-green-400 hover:bg-green-500 text-white font-bold p-2 rounded w-80" type="submit" value="Send"><span>Envoyer</span></button>
            </form>
          </div>
        </>
  );
